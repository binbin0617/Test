 ...
 */
package com.bin.mylibrary.activity;
...
//    }
    ...
    private CountDownTimer countDownTimer = new CountDownTimer(20 * 1000 + 300, 1000) {
        @Override
...
//        return new MyPlanarYUVLuminanceSource(data, width, height, 0, 0, rect.width(), rect.height(), false);
