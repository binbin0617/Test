...
package com.bin.mylibrary.decode;
...
public class DecodeHandler extends Handler {
    ...
    private WeakReference<Map<DecodeHintType, Object>> hintsRef;
...
//        result = result || decodeByZbar(rotatedData);
    ...
    private boolean decodeByZXing(byte[] rotatedData, int width, int height) {
        ...
        if (source != null) {
            ...
            //先用 高级算法进行二值化
            try {
                rawResult = mQRCodeReader.decode(bitmap, hintsRef.get());
...
//                try {
//                    rawResult = mQRCodeReader.decode(bitmap2);
