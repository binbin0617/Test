...
public class RecognizeService {
    ...
    public interface ServiceBankCardListener {
    ...
    public static void recBankCard(Context ctx, String filePath, final ServiceBankCardListener listener) {
...
//                        result.getBankName());
            ...
            public void onError(OCRError error) {
                ...
                bankCardResult.setBankName(error.getMessage());
                bankCardResult.setBankCardNumber("-1");
                listener.onResult(bankCardResult);
            }
        });
    }
